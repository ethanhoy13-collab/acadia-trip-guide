...
const BONUS = [
  {
    ...
    coords: [-71.6813, 44.1213], routeIdx: 1506,
    tag: "Three swimming-hole legends, one exit off I-93",
    desc: "The Basin: a glacially-carved granite pothole, 30 seconds from the parking lot. From there, the Basin-Cascades Trail climbs past Kinsman Falls to the famous 'infinity pool' — a natural tub on a granite ledge staring straight down Franconia Notch. That pool is the one from the video Ethan sent — this is the spot. And ten minutes south, Georgiana Falls is a quieter 2-mile round trip with pools at the base. This is THE swim day of the drive east.",
    tips: ["Infinity pool = ~1 mile up the Basin-Cascades Trail; go early, it's TikTok-famous now.", "Georgiana Falls trailhead is off Hanson Farm Rd — small lot, easy grade."],
  },
  {
  ...
  },
  {
    ...
    tips: ["From Rt 113 take Stone House Rd, park at the gate on Shell Pond Rd, walk in.", "No cell service in Evans Notch — download offline maps first.", "Pack out everything; this stays open only because people behave."],
  },
  {
