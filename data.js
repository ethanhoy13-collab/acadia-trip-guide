...
const BONUS = [
  ...
  },
  {
    ...
    tips: ["Free parking, paved path, 5 minutes — zero excuse to skip it.", "No swimming in the Basin itself, but the Basin-Cascades Trail above it climbs past more cascades and pools (Kinsman Falls) if you want to stretch your legs.", "Georgiana Falls and its infinity pool (next card) are 10 minutes down the road — do both."],
  },
  {
    id: "franconia", pick: "ethan",
    name: "Georgiana Falls & the Infinity Pool",
    place: "Hanson Farm Rd, Lincoln, NH · White Mountains",
    coords: [-71.7000, 44.0690], routeIdx: 1506,
    tag: "The granite hot-tub ledge with I-93 a thousand feet below your toes",
    pics: [
      {f:"media/online/infinitypool-1.jpg", credit:"Frame from the scouting video — this is the spot"},
    ],
    desc: "This is the pool from the video — and it finally has a name: the ledge pool at the top of Harvard Falls, the upper tier of Georgiana Falls. An unmarked-but-well-loved path follows Harvard Brook about 1.3 miles to the lower falls (water slides pouring into a swimmable pool), then climbs a steep half-mile to the top, where a natural granite tub sits on the brink with the whole valley and highway spread out below. Ten minutes from The Basin, and together they're THE swim day of the drive east.",
    tips: ["Trailhead is a small lot off Hanson Farm Rd (the path crosses under I-93 on the way in) — about 3.5 miles round trip to the top.", "Go early: the pool is internet-famous now and holds about four people.", "The upper climb is steep and the granite near every edge is slick when wet — good shoes, careful feet."],
  },
  {
