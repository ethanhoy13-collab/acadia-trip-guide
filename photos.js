// ============================================================
// Media manifest — files live in media/<key>/ (web-optimized).
// Originals kept in photos/. .mp4 entries render as video.
// Order = chronological within each stop.
// ============================================================

const HERO_IMG = "media/08-thunder-hole/IMG_4500.jpg";

const PHOTOS = {
  "01-taughannock-falls": { files: [
    "IMG_0950.jpg","IMG_0952.jpg","IMG_2776.jpg","IMG_0960.mp4","IMG_2790.jpg","IMG_2808.jpg","IMG_0984.jpg"
  ]},
  "02-kaaterskill-falls": { files: [
    "IMG_4292.jpg","IMG_4294.mp4","IMG_4295.jpg","IMG_4300.mp4"
  ]},
  "03-split-rock-falls": { files: [
  ...
  "07-bar-harbor": { files: [
    "IMG_4457.jpg","IMG_4460.jpg","IMG_4465.jpg","IMG_4466.mp4"
  ]},
  "08-thunder-hole": { files: [
